...
For high-level development, the popular languages are of the scripting-kind like Lua, which is a 'multi-paradigm' language.
...
This means that countless hours of work are spent to extend functionality of a language, not tailored for the specific task, and the construction of game-engines is needed to save developers time on the low-level implementation.
