...
\subsection{\langname{} semantics}
	...
	$Character : CName \rightharpoonup Behaviour \times \mathcal{P}(AName) \times env \times EName \times Resource$\\
	...
	$Ability: AName \rightharpoonup \mathcal{P}(RGR) \times Effect \times Integer \times Integer$\\
	...
	$RGR = \{\texttt{owner, enemy}\}$\\
	\ac{rgr} is the set of keyword, used for references.\\
	$Behaviour: BName \rightharpoonup \mathcal{P}(RGR \times VName \times Integer)$\\
...
\end{tabular}
\begin{tabular}{l p{0.97\textwidth}}
