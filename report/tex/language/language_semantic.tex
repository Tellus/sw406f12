...
%
Transition rules for declaration of abilities can be seen in table \ref{tbl:decA}.
...
%
Transition rules for declaration of behaviour can be seen i table \ref{tbl:decB}.
...
%
Transition rules for declaration of character can be seen i table \ref{tbl:devC}.
