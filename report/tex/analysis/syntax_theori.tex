...
Every programming language, has some basic symbols, these could be ``expression'', ``value'' etc. %These basic symbols have to be specified, so it is possible for a compiler to determine, if the programmer has made a mistake. \\
...
%Different ways to specify the basic symbols, of a programming language, exist, although, most programming languages use \ac{regex} to specified the basic symbols. \cite{Fischer2010}
